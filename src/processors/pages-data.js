...
module.exports = function(conf){
  AREA_NAMES = _.extend({},AREA_NAMES,conf.AREA_NAMES);
  return function generatePagesDataProcessor(log) {
    var navGroupMappers = {
    ...
    return {
      ...
      $process: function(docs) {
        ...
        //
        var areas = {};
        var ss = _.groupBy(navPages,'area');
        // _(navPages)
        //   .groupBy('area')
        //   .value();
        
          _.forEach(ss,function(pages, areaId) {
            var area = {
              id: areaId,
